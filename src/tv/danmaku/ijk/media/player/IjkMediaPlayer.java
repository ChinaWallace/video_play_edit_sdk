...
import tv.danmaku.ijk.media.player.exceptions.AccessedByNative;
import tv.danmaku.ijk.media.player.exceptions.CalledByNative;
import tv.danmaku.ijk.media.player.exceptions.DebugLog;
...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
     ...
     */
    @Override
    public void setDisplay(SurfaceHolder sh) {//<--------------从这里开始.
        mSurfaceHolder = sh;
        Surface surface;
        if (sh != null) {
    ...
    @Override
    public void executeVideoEditor(String[] array)  {
        execute_video_editor(array);
    }
    ...
    private native void execute_video_editor(Object cmdArray);
